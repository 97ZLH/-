<?php
    ...
    */
    ...
    // $qsl = "SELECT * FROM goodslist LIMIT $index,$qty";
    ...
    if($page&&$qty){
        ...
        $qsl = "SELECT * FROM goodslist  ORDER BY new_price DESC LIMIT $index,$qtyDown";
    }else if($pageUP&&$qtyUP){
        $index = ($pageUP-1) * $qtyUP;
        $qsl = "SELECT * FROM goodslist  ORDER BY new_price ASC LIMIT $index,$qtyUP";
    }
